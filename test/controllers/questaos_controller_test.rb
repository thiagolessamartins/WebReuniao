...
class QuestaosControllerTest < ActionController::TestCase
  ...
  test "should create questao" do
    assert_difference('Questao.count') do
      post :create, questao: { data: @questao.data, pessoa_id: @questao.pessoa_id, solucao: @questao.solucao, status: @questao.status, titulo: @questao.titulo }
    end
  ...
  test "should update questao" do
    patch :update, id: @questao, questao: { data: @questao.data, pessoa_id: @questao.pessoa_id, solucao: @questao.solucao, status: @questao.status, titulo: @questao.titulo }
    assert_redirected_to questao_path(assigns(:questao))
  end
